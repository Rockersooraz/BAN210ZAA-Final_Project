...
retain parent "Reg" MODEL "Reg" MODELDESCRIPTION "Regression" TARGETLABEL "class";
set EMWS1.Reg_EMRANK;
where upcase(TARGET) = upcase("class");
run;
...
retain parent "Neural" MODEL "Neural" MODELDESCRIPTION "Neural Network" TARGETLABEL "class";
