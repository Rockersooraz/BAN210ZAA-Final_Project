...
then do;
if (201+1-_C000004)*_genvalue_ <= (80 - _C000001) then do;
_C000001 + 1;
output EMWS1.Part_TRAIN;
end;
else do;
if (201+1-_C000004)*_genvalue_ <= (80 - _C000001 + 60 - _C000002) then do;
_C000002 + 1;
...
then do;
if (85+1-_C000008)*_genvalue_ <= (34 - _C000005) then do;
_C000005 + 1;
output EMWS1.Part_TRAIN;
end;
else do;
if (85+1-_C000008)*_genvalue_ <= (34 - _C000005 + 26 - _C000006) then do;
_C000006 + 1;
output EMWS1.Part_VALIDATE;
end;
else do;
