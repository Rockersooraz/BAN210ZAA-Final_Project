...
'Residual: class=no-recurrence-events' ;
   R_classrecurrence_events = - _P0;
   R_classno_recurrence_events = - _P1;
   select( _Y );
      when (0)  R_classrecurrence_events = R_classrecurrence_events + 1;
      when (1)  R_classno_recurrence_events = R_classno_recurrence_events + 1;
   end;
end;
